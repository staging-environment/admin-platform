    ...
    */
    ...
    'connections' => [
        ...
        'administracioncorporativa' => [
            'driver' => 'mysql',
            'host' => env('DB_CORP_HOST', '127.0.0.1'),
            'port' => env('DB_CORP_PORT', '32828'),
        ...
        'virtusgesnet' => [
            'driver' => 'mysql',
            'host' => env('DB_VIRTUS_HOST', '127.0.0.1'),
            'port' => env('DB_VIRTUS_PORT', '32828'),
        ...
        // Nueva conexión aislada para la base de datos del FTP
        'mariadb_ftp' => [
            'driver' => 'mariadb',
            'url' => env('DB_URL'),
            'host' => env('FTP_DB_HOST', '127.0.0.1'),
