            ...
            ->columns([
                TextColumn::make('nombre')
                    ...
                    ->formatStateUsing(function ($state, $record) {
                        ...
                        $editHtml = $canEdit 
                            ? "<button type=\"button\" wire:click=\"mountTableAction('edit', '{$record->id}')\" class=\"doc-btn doc-btn-edit\" style=\"display: inline-flex !important; align-items: center !important; justify-content: center !important; padding: 6px !important; border-radius: 6px !important; color: #d97706;\" title=\"Editar Documento\">
                            ...
                            : "";
                        $deleteHtml = $canEdit 
                            ? "<button type=\"button\" wire:click=\"mountTableAction('delete', '{$record->id}')\" class=\"doc-btn doc-btn-delete\" style=\"display: inline-flex !important; align-items: center !important; justify-content: center !important; padding: 6px !important; border-radius: 6px !important; color: #dc2626;\" title=\"Borrar Documento\">
                                <svg class=\"w-4 h-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"2\" stroke=\"currentColor\">
                        ...
                        return new HtmlString("
                            <div style=\"display: flex !important; flex-direction: row !important; align-items: center !important; justify-content: space-between !important; gap: 8px !important; width: 100% !important; min-width: 0 !important;\">
                                <span style=\"font-size: 0.875rem !important; font-weight: 500 !important; white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important; flex-grow: 1 !important; min-width: 0 !important;\" title=\"{$state}\">
                                    {$state}
                                </span>
                                <div style=\"display: flex !important; flex-direction: row !important; align-items: center !important; gap: 4px !important; flex-shrink: 0 !important;\">
                                    <button type=\"button\" wire:click=\"mountTableAction('preview', '{$record->id}')\" class=\"doc-btn doc-btn-preview\" style=\"display: inline-flex !important; align-items: center !important; justify-content: center !important; padding: 6px !important; border-radius: 6px !important; color: #0284c7;\" title=\"Previsualizar\">
                                        <svg class=\"w-4 h-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"2\" stroke=\"currentColor\">
                                            <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z\" />
                                            <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z\" />
                                        </svg>
                                    </button>
                                    <a href=\"{$downloadUrl}\" target=\"_blank\" class=\"doc-btn doc-btn-download\" style=\"display: inline-flex !important; align-items: center !important; justify-content: center !important; padding: 6px !important; border-radius: 6px !important; color: #059669;\" title=\"Descargar\">
                                        <svg class=\"w-4 h-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"2\" stroke=\"currentColor\">
