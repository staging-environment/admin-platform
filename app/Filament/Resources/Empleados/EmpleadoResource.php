                    ...
                    ->schema([
                        \Filament\Schemas\Components\Html::make('
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; margin-bottom: 16px;" class="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 rounded-2xl text-sm text-red-800 dark:text-red-400">
                                ...
                                <div>
                                    <strong class="font-bold">Contrato no registrado:</strong>
                                    Este empleado no tiene ningún documento de contrato asociado en su ficha. Por favor, suba un contrato para registrar y validar su ubicación de trabajo, puesto y tipo de contrato.
                                </div>
                            </div>
                        ')
                        ...
                        \Filament\Schemas\Components\Html::make('
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; margin-bottom: 16px;" class="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-2xl text-sm text-green-800 dark:text-green-400">
                                <svg style="width: 24px; height: 24px; flex-shrink: 0;" class="text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <div>
                                    <strong class="font-bold">Trabajando actualmente:</strong>
                                    El trabajador se encuentra de alta médica y en servicio activo.
                                </div>
                            </div>
                        ')
                        ...
                        \Filament\Schemas\Components\Html::make('
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; margin-bottom: 16px;" class="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 rounded-2xl text-sm text-red-800 dark:text-red-400">
                                ...
                                <div>
                                    <strong class="font-bold">De baja médica:</strong>
                                    El trabajador se encuentra actualmente de baja médica (incapacidad temporal).
                                </div>
                            </div>
                        ')
                            ->visible(fn ($record) => $record && $record->estado === 'Alta' && $record->ausencias()->where('tipo', 'Bajas médicas')->whereNull('fecha_fin')->exists())
