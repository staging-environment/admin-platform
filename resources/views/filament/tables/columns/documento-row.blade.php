...
<div class="flex items-center justify-between gap-x-2 w-full" style="display: flex !important; flex-direction: row !important; align-items: center !important; justify-content: space-between !important; width: 100% !important; min-width: 0 !important;">
    <span class="text-sm font-medium text-gray-800 dark:text-gray-200 truncate" title="{{ $state }}" style="flex-grow: 1 !important; min-width: 0 !important; white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important;">
        {{ $state }}
    </span>
    <div class="flex items-center gap-x-1 flex-shrink-0" style="display: flex !important; flex-direction: row !important; align-items: center !important; gap: 4px !important; flex-shrink: 0 !important;">
        <!-- Previsualizar -->
        <button type="button" 
