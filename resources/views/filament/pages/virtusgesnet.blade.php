                        ...
                        <div class="p-5 flex flex-wrap gap-2 max-h-[250px] overflow-y-auto">
                            ...
                            @else
                                @foreach($tables as $tableName)
                                    <button
                                        onclick="window.open('{{ route('db.preview', ['connection' => 'virtusgesnet', 'table' => $tableName]) }}', 'virtus_table_{{ $tableName }}', 'width=1100,height=750,resizable=yes,scrollbars=yes')"
