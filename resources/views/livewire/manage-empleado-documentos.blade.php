                            ...
                            <td class="px-2 py-2 w-48">
                                <div class="flex items-center justify-start gap-1">
                                    ...
                                    @else
                                        ...
                                        {{-- Editar --}}
                                        @if ($family === 'contratos' || $family === 'dni')
                                            <button type="button" wire:click="editDocument({{ $doc->id }})" class="inline-flex items-center justify-center p-1 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/20 rounded-md transition-all" title="Editar">
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        {{-- Eliminar --}}
                                        <button type="button" wire:click="deleteDocument({{ $doc->id }})" wire:confirm="¿Estás seguro de que deseas eliminar este documento?" class="inline-flex items-center justify-center p-1 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-md transition-all" title="Eliminar">
                                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
